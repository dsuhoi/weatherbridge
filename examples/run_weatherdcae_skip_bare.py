"""Legacy WeatherDCAE-Skip 14.4M (6h) bare-blob load."""
...
def main():
    ...
    model = load_bare(REPO_ROOT / "weights" / "weatherdcae_skip_14m_6h_bare.pt", device)
    print(f"loaded WeatherDCAE-Skip 6h: "
