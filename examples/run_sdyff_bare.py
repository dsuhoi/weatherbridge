"""S-DYff 101M (6h) — bare blob load. Forward is diffusion-stochastic."""
...
# S-DYff's SHT layer reads these once at module import time.
...
def main():
    ...
    model = load_bare(REPO_ROOT / "weights" / "sdyff_101m_6yr_bare.pt", device)
    print(f"loaded S-DYff: "
