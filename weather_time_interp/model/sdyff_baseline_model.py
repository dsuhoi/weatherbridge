...
- DropPath remains active in eval mode; ordinary nn.Dropout does not.
  MC-dropout evaluation must enable dropout modules explicitly and average
  repeated predictions. A plain eval-mode forward is one stochastic draw.
